...
\Large
A pairwise A/B study (more accurate? / less wrong?) judged by an LLM panel ---
3 audio judges that hear the clip, 5 text judges given the human reference.
Every panel \textbf{prefers GPT-2-best over T5-best}, corroborating that the
cheaper decoder-only model is the stronger captioner; the \textbf{human
reference still wins}, the honest ceiling. (Human raters: study live, data pending.)
\begin{center}
\includegraphics[width=0.82\linewidth]{fig_eval_winrate.pdf}
\end{center}
