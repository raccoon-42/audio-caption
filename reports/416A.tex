...
in this report is generated from the result JSONs by the scripts under
\texttt{scripts/reporting/}: \texttt{thesis\_tables.py} and \texttt{figures.py};
the vocalist-bias statistics come from \texttt{scripts/reporting/vocal\_bias.py}.
\end{sloppypar}
