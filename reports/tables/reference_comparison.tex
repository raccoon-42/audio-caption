...
GPT-2 (S1) $n{=}529$, GPT-2 (S2) $n{=}529$, GPT-2 (best dec.) $n{=}529$, T5 (best dec.) $n{=}529$, LP-MusicCaps (pretrain) $n{=}529$, LP-MusicCaps (transfer, held-out) $n{=}284$, BLAP (held-out) $n{=}284$, LP-MusicCaps (transfer) $n{=}529$, BLAP $n{=}529$, Audio Flamingo $n{=}529$, Qwen2-Audio $n{=}529$, Qwen3-Omni Captioner $n{=}528$.}
