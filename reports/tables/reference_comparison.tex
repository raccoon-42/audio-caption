...
pseudo-captions, so it is leakage-free on this split. Sample counts: GPT-2 (S1) $n{=}529$, GPT-2 (S2) $n{=}529$, Audio Flamingo $n{=}529$, Qwen2-Audio $n{=}529$, Qwen3-Omni Captioner $n{=}528$, LP-MusicCaps (pretrain) $n{=}529$.}
