\begin{table}[ht]
\centering
\caption{T5 decoding ablations --- top 15 by FENSE, AAC-specific metrics. The greedy row is the baseline; its $\pm$ is the run-to-run training noise floor, shown for context only --- all rows decode the same checkpoint, so differences between configurations are exact.}
...
\midrule
greedy & 0.5564 $\pm$0.0170 & 0.3251 $\pm$0.0511 & 0.3954 $\pm$0.0345 \\
trim\_rep1.2 & \textbf{0.5762} & \textbf{0.0000} & \textbf{0.5762} \\
