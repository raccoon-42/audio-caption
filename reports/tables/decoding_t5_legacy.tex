\begin{table}[ht]
\centering
\caption{T5 decoding ablations --- top 15 by FENSE, Legacy metrics. The greedy row is the baseline; its $\pm$ is the run-to-run training noise floor, shown for context only --- all rows decode the same checkpoint, so differences between configurations are exact.}
...
\midrule
greedy & 0.3003 $\pm$0.0122 & \textbf{0.0574 $\pm$0.0048} & \textbf{0.1162 $\pm$0.0036} & \textbf{0.2275 $\pm$0.0027} & 0.0847 $\pm$0.0181 & 0.0866 $\pm$0.0124 & 0.0857 $\pm$0.0149 \\
